...
| :--- | :--- | :--- | :--- |
| **VQA Top-1 Accuracy** | 52.3% (Static Regex) | **30.0%** (HuggingFace ViLT-b32) | **Real Metric** |
| **VQA F1-Score** | 48.0% | **28.5%** | **Real Metric** |
| **Grounding mIoU** | 0.00 (Not Implemented) | **0.0%** (HuggingFace OWL-ViT) | **Real Metric** |
| **Grounding Pointing Acc.** | 0.0% | **0.0%** | **Real Metric** |
